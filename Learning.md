...
# AI安全
AI安全主要就是实验室的方向，也是项目相关的方向。这一块很难一下子全部看完，这里主要介绍几个方向，而我们主要的关注点是在数字水印技术和感知哈希上面。 你可以从参考文献的**综述**入手，主要从数据样本的安全，模型安全和生成式样本的安全问题(版权问题，溯源问题，追责问题)这观点来思考如何用现有的技术来解决这些问题。
